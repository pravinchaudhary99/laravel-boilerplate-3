    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="d-flex flex-column flex-lg-row">
                <!--begin::Content-->
                <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-5">
                    <!--begin::Card-->
                    <div class="card">
                        <!--begin::Card body-->
                        <div class="card-body p-12">
                            <!--begin::Form-->
                            <form action="{{ route('invoice.create') }}" method="POST" id="kt_invoice_form">
                                @csrf
                                <!--begin::Wrapper-->
                                <div class="d-flex flex-column align-items-start flex-xxl-row">
                                    ...
                                    <div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
                                        ...
                                        <div class="position-relative d-flex align-items-center w-150px">
                                            <!--begin::Datepicker-->
                                            <input class="form-control form-control-transparent fw-bold pe-5 flatpickr-input active" placeholder="Select date" name="start_date" type="text" readonly="readonly">
                                            <!--end::Datepicker-->
                                            <!--begin::Icon-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice due date">
                                        ...
                                        <div class="position-relative d-flex align-items-center w-150px">
                                            <!--begin::Datepicker-->
                                            <input class="form-control form-control-transparent fw-bold pe-5 flatpickr-input active" placeholder="Select date" name="due_date" type="text" readonly="readonly">
                                            <!--end::Datepicker-->
                                            <!--begin::Icon-->
                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row gx-10 mb-5">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid" name="from_address" placeholder="Address" />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid" name="from_state" placeholder="State" />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid" name="from_pincode" placeholder="Pin code" />
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid" name="to_address" placeholder="Address" />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid" name="to_state" placeholder="State" />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid" name="to_pincode" placeholder="Pin code" />
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        <!--end::Col-->
                                            ...
                                            <tfoot>
                                                <tr class="border-top border-top-dashed align-top fs-6 fw-bold text-gray-700">
                                                    <th class="text-primary">
                                                        <button type="button" style="color: #009ef7;" class="btn btn-sm btn-light me-3 py-3" data-kt-element="add-item">Add item</button>
                                                    </th>
                                                    <th colspan="2" class="border-bottom border-bottom-dashed ps-0">
                                                        <div class="d-flex flex-column align-items-start">
                                                            <div class="fs-5 py-3">Subtotal</div>
                                                            <div class="fs-5 py-3">Add tax</div>
                                                            <div class="fs-5 py-3">Add Discount</div>
                                                    ...
                                                    <th colspan="2" class="border-bottom border-bottom-dashed text-end" >
                                                        <div class="d-flex flex-end" style="align-items:center;" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Enter tax" data-kt-initialized="1">
                                                            <span>$</span>
                                                            <span class="form-control form-control-flush fw-bold text-muted w-100px flex-start" style="text-align: left;
                                                            padding-left: 12px;" data-kt-element="sub-total">0.00</span>
                                                        </div>
                                                        <div class="d-flex flex-end" style="align-items:center;" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Enter tax" data-kt-initialized="1">
                                                            <span class="fw-bold">%</span>
                                                            <input type="text" class="form-control form-control-flush w-100px" name="tax" placeholder="0.00" data-kt-element="tax">
                                                        </div>
                                                        <div class="d-flex flex-end" style="align-items:center;" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Enter discount" data-kt-initialized="1">
                                                            <span class="fw-bold">%</span>
                                                            <input type="text" class="form-control form-control-flush w-100px" name="discount" placeholder="0.00" data-kt-element="discount">
                                                        </div>
                                                    </th>
                                                </tr>
